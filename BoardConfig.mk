...
BOARD_KERNEL_CMDLINE += androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x37 ehci-hcd.park=3 lpm_levels.sleep_disabled=1
...
BOARD_KERNEL_CMDLINE += androidboot.hab.product=lake androidboot.hab.csv=2 androidboot.hab.cid=50
